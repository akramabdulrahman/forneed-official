                    ...
                    <div class="portlet-body">
                        ...
                        <div style="padding:5px"><i class="pull-left">Survay Progress :</i>
                            <span class="easy-pie-chart">
															<div class="number transactions pull-left"
                                                                 data-percent="{{ceil($survey->progress)}}"
                    ...
                    <div class="portlet-title">
                        <div class="">
                            ...
                            <div class="pull-right">
                                <a href="{{route('endusers.org.projects.surveys.questions.create',$survey->id)}}"
                                   class="btn blue"><i class="fa fa-plus"
                                                       aria-hidden="true"></i> Add New Question</a>
                                <a href="{{route('importExport.surveys.form',$survey->id)}}"
                                   class="btn blue"><i class="fa fa-book"
                                                       aria-hidden="true"></i> Excel Input</a>
                            </div>
                        </div>
