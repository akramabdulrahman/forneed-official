        ...
        <div class="page-content" style="background-color:#fff">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    <li>
                        <a href="{{route('endusers.org.projects.surveys.show',$question->survey_id)}}">Questions</a>
            ...
            <!-- END PAGE BAR -->
            <!-- BEGIN PAGE TITLE-->
            <h3 class="page-title"> Edit Question
                <small></small>
            </h3>
            ...
            <div class="row">
                <div class="col-md-6">
                    {!! Form::model($question, ['route' => ['endusers.org.projects.surveys.questions.update', $question->id], 'method' => 'patch']) !!}

                    @include('endusers.organizations.forms.questions.fields',['update'=>true])
