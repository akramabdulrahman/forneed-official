                        ...
                        <form method="POST " id="search-form" class="form-horizontal">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <div class=" col-md-12 ">
                                            {!! Form::select('targets[]',$extra_types ,old('targets[]'), ['multiple','data-style'=>'btn-default','placeholder'=>'Beneficiaries Criteria','class' => 'selectpicker show-tick show-menu-arrow form-control']) !!}
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <div class=" col-md-12 ">
                                            {!! Form::select('criteria[]',$extra_types_sp ,old('criteria[]'), ['multiple','data-style'=>'btn-default','placeholder'=>'Organization Criteria','class' => 'selectpicker show-tick show-menu-arrow form-control']) !!}
                                        </div>
                                    </div>
                            ...
                            <div class="margin-top-10">
                                ...
                                <input type="reset" class="btn blue"
                                       onclick="window.LaravelDataTables.dataTableBuilder.draw();">
